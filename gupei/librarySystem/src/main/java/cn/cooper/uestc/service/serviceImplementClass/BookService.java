...
//service包中应该分为两个包，一个包是service接口，定义了controller类中的各种方法
//一个包放service方法的实现类，这样做的目的是条理清晰，各自具有各自的功能，提供代码逻辑更清晰
//更方便的提供给别人看
...
public class BookService {
    ...
    public List<BookDo> getAllBooks() {
        ...
        //那么BookMapper中定义的方法是对数据库进行操作，如查询。cn.cooper.uestc.imoccLibraryDifferentWithWebSystem.Book Condition作为参数传入方法，那么整体达到的效果
